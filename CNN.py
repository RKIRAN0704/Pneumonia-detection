...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory('D:\\Fathima\\Python\\Pneumonia Classification\\data\\train',
                                                 target_size=(64,64),
                                                 batch_size=12,
                                                 class_mode='categorical'
                                                 )

test_set = test_datagen.flow_from_directory('D:\\Fathima\\Python\\Pneumonia Classification\\data\\test',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical'
                                            )
...
classifier.save(r"D:\Fathima\Python\Pneumonia Classification\CNN.h5")
...
plt.ylabel('accuracy')
plt.legend()
plt.savefig(r"D:\Fathima\Python\Pneumonia Classification\CNN_acc.png")
plt.show()
...
plt.ylabel('loss')
plt.legend()
plt.savefig(r"D:\Fathima\Python\Pneumonia Classification\CNN_loss.png")
plt.show()
